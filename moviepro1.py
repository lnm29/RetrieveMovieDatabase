...
with con:
	...
	with open("actors.csv") as theFile:
		reader = csv.reader(theFile)
		for field in reader:
			cur.execute("INSERT INTO Actors VALUES(?, ?, ?, ?);", field)
			
	with open("cast.csv") as theFile:
		reader = csv.reader(theFile)
		for field in reader:
			cur.execute("INSERT INTO Cast VALUES(?, ?, ?);", field)
			
	with open("directors.csv") as theFile:
		reader = csv.reader(theFile)
		for field in reader:
			cur.execute("INSERT INTO Directors VALUES(?, ?, ?);", field)
			
	with open("movie_dir.csv") as theFile:
		reader = csv.reader(theFile)
		for field in reader:
			cur.execute("INSERT INTO Movie_Director VALUES(?, ?);", field)
			
	with open("movies.csv") as theFile:
		reader = csv.reader(theFile)
		for field in reader:
...
'''	
	...
	#queries = collections.OrderedDict(sorted(queries.items(), key=lambda t: getkey(t[0])))
	########################################################################		
